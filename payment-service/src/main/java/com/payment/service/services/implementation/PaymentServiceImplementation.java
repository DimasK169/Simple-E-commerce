...
public class PaymentServiceImplementation implements PaymentService {
    ...
    public RestApiResponse<PaymentSaveResult> createPayment(PaymentRequest paymentRequest) throws JsonProcessingException, ParseException {
        CartEntity cartEntity = cartRepository.findById(paymentRequest.getCartId())
        ...
        PaymentEntity paymentEntity = PaymentEntity.builder()
                ...
                .paymentPrice(cartEntity.getCartTotalPrice().toString())
        ...
        body.put("transaction_details", Map.of(
                ...
                "gross_amount", cartEntity.getCartTotalPrice().toString()
        ));
