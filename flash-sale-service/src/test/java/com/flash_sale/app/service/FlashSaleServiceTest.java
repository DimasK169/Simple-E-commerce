...
public class FlashSaleServiceTest {
    ...
    public void FlashSaleService_Create_ReturnFlashSaleDto() throws JsonProcessingException {
        ...
        FlashSaleRequest request = FlashSaleRequest.builder()
                ...
                .fsCode("FS2025")
                .fsStartDate(new Date(getTime() - (1000 * 60 * 60 * 24)))
                .fsEndDate(new Date(getTime() + (1000 * 60 * 60 * 24)))
                .fsCreatedBy("admin")
                .trxDiscount(0.2)
    ...
    public void FlashSaleService_Update_ReturnUpdatedFlashSaleDto() throws JsonProcessingException {
        ...
        // When
        when(flashSaleRepository.findByFsCode(fsCode)).thenReturn(List.of(existingFlashSale));
    ...
    public void FlashSaleService_UpdateFlashSale_ProductNotFound_ThrowsException() {
        ...
        FlashSaleUpdateRequest request = FlashSaleUpdateRequest.builder()
                .fsName("Update Flash")
                .fsCreatedBy("admin")
                .fsStartDate(new Date(System.currentTimeMillis() - (1000 * 60 * 60 * 24)))
                .fsEndDate(new Date(System.currentTimeMillis() + (1000 * 60 * 60 * 24)))
                .trxDiscount(0.1)
                .productCode(List.of(productCode))
                .build();

        // FlashSale ditemukan (mock flash sale yang ada)
        when(flashSaleRepository.findByFsCode(fsCode)).thenReturn(
                List.of(FlashSale.builder()
                        .fsId(1L)
                        .fsCode(fsCode)
                        .fsProduct("SomeProduct")
    ...
    public void FlashSaleService_GetByCode_ReturnFlashSaleList() throws JsonProcessingException {
        ...
        // When
        when(productRepository.findByproductCode("IP15")).thenReturn(List.of(product));
