package com.user.app.controller.advice;
...
import com.user.app.utility.CoreThrowHandler;
...
public class ControllerAdvice {
    ...
    public ResponseEntity<RestApiResponse<Object>> handleUnauthorizedException(UnauthorizedException ex) {
